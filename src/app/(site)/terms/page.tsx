  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        { heading: "4. Liability", body: "TourNature-Bio acts as an intermediary between travelers and service providers. We are not liable for events beyond our reasonable control, including weather, strikes or force majeure." },
